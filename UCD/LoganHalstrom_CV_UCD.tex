...
\newcommand{\CVTitle}{Logan Halstrom's CV for University of California, Davis}
...
\SubBulletItem
Thesis:
{Computational Fluid Dynamics Simulation of Parachute Pendulum Motion and Dynamic Stability}
\SubBulletItem
Adviser:
Prof.~Stephen~Robinson
\SubBulletItem
Focus:
Computational Fluid Dynamics, bluff-body flow, dynamics
\end{detail}
